...
mod tests {
    use super::{
        GitAuthor, git_commit_all, git_dir_within_root, git_file_has_changes, git_file_in_head,
        git_reset_workspace, git_restore_file, git_show_file, git_status_and_diff,
    };
